!(function (e) {
    ...
    e(".multi-side-hover").each(function () {
        ...
        e("nav#dropdown").meanmenu({
            siteLogo:
                "<div class='mobile-menu-nav-back'><a class='logo-mobile' href='index.html'><img src='user/assets/img/logo.png' alt='logo' class='img-fluid'/></a></div>",
        }),
                        ...
                        function () {
                            e({ value: 0 }).animate(
                                { value: t },
                                {
                                    ...
                                    easing: "swing",
                                    step: function () {
                                        a.val(Math.ceil(this.value)).trigger(
                                            "change"
                                        );
                                    },
                                }
    ...
    d
        ...
        e(".panel-heading a", d).on("click", function (a) {
            e(this)
                ...
                .hasClass("show") && (a.preventDefault(), a.stopPropagation());
        });
    ...
    e(".rc-carousel").each(function () {
        ...
        e(window).on("scroll", function () {
            var a = e("#sticker"),
                ...
                l =
                    (r.find(".header-top-bar").outerHeight(),
                    a.prev(".header-top-bar"));
            if (i > 991) {
                t.css("padding-top", "");
                var d;
                s.length
