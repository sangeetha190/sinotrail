                                    ...
                                    <div class="col-xl-12 col-lg-12 col-md-12">
                                        <div class="call-to-action-box-layout4 text-center text-lg-start">
                                            <div class="call-to-action-btn">
                                                <a href="{{ route('contact') }}" class="item-btn btn btn-primary">
                                                    Make an Appointment
                                                </a>
                                            </div>
                                        </div>
        ...
        <section class="shop-wrap-layout1 bg-light-primary100 bg-light-secondary100">
            <div class="container">
                ...
                <div class="rc-carousel dot-control-layout3" data-loop="true" data-items="4" data-margin="30"
                    ...
                    data-r-x-medium-dots="true" data-r-small="2" data-r-small-nav="false"
                    data-r-small-dots="true" data-r-medium="3" data-r-medium-nav="false"
                    data-r-medium-dots="true" data-r-large="4" data-r-large-nav="false" data-r-large-dots="true"
                    data-r-extra-large="4" data-r-extra-large-nav="false" data-r-extra-large-dots="true">
        ...
        <section class="departments-wrap-layout2 bg-light-secondary100 py-5">
            <div class="container">
                ...
                <div class="rc-carousel nav-control-layout2" data-loop="true" data-items="4" data-margin="20"
                    ...
                    data-r-x-medium-dots="false" data-r-small="2" data-r-small-nav="false"
                    data-r-small-dots="false" data-r-medium="3" data-r-medium-nav="false"
                    data-r-medium-dots="false" data-r-large="4" data-r-large-nav="false"
